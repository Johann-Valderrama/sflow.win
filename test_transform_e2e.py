...
def main() -> int:
    ...
    # Lo ÚNICO que se finge: la llamada al modelo.
    ...
    print(f"1. ventana de prueba PROPIA: hwnd={hwnd_editor}")
    ...
    try:
        ...
        print(f"4. pulsando '{TECLA_PROMPT}' DE VERDAD sobre el panel")
        ...
        print("5. pulsando Enter DE VERDAD para aplicar")
        kb.press(Key.enter)
